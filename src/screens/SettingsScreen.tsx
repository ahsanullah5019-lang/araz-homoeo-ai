...
export const SettingsScreen: React.FC = () => {
  ...
  // ফায়ারবেস ক্লাউডে অফলাইন ডাটা পুশ করার ম্যানুয়াল ট্রিগার লজিক
  const handleManualSync = () => {
    ...
    setTimeout(() => {
      ...
      setIsSyncing(false);
      alert('অফলাইন ডেটা সফলভাবে ফায়ারবেস ক্লাউডে সুরক্ষিত করা হয়েছে!');
    }, 2500);
  };
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', maxWidth: '600px' }}>
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            <div>
              <span style={{ fontSize: '13px', color: theme.colors.textSecondary, display: 'block', marginBottom: '5px' }}>
                ডাক্তারের নাম / চেম্বার টাইটেল
              </span>
              <input
                type="text"
